...
void file_ok_sel (GtkWidget *w) {
  ...
  /*
  gchar *sTempFile;
  sTempFile = gtk_file_chooser_dialog_new (GTK_FILE_SELECTION (fs));
...
gboolean dialogGameSetupChooseMap(GtkWidget *widget,  GdkEventButton *event, gpointer user_data) {
  ...
  /*
  filew = gtk_file_chooser_dialog_new ("Open Map File...");

  g_signal_connect(filew, "destroy", (GtkSignalFunc) DestroyDialog, &filew);

  g_signal_connect(GTK_OBJECT (GTK_FILE_SELECTION (filew)->ok_button), "clicked", (GtkSignalFunc) file_ok_sel, filew );
  g_signal_connect(GTK_OBJECT (GTK_FILE_SELECTION (filew)->cancel_button), "clicked", (GtkSignalFunc) file_cancel_sel, filew);
...
gboolean dialogGameSetupCompTanks(GtkWidget *widget,  GdkEventButton *event, gpointer user_data) {
  if (gtk_toggle_button_get_active(GTK_TOGGLE_BUTTON(widget)) == TRUE) {
    ...
    gtk_toggle_button_set_active(GTK_TOGGLE_BUTTON(idc_gamesetupcomptanks2), FALSE);
...
gboolean dialogGameSetupShow(GtkWidget *widget,  GdkEventButton *event, gpointer user_data) {
  ...
  if (password[0] != '\0') {
    ...
    gtk_widget_set_sensitive (idc_gamesetuptextpassword, TRUE);
    gtk_toggle_button_set_active(GTK_TOGGLE_BUTTON(idc_gamesetupgamepassword), TRUE);
  } else {
    gtk_entry_set_text(GTK_ENTRY(idc_gamesetuptextpassword), "");
    gtk_widget_set_sensitive (idc_gamesetuptextpassword, FALSE);
    gtk_toggle_button_set_active(GTK_TOGGLE_BUTTON(idc_gamesetupgamepassword), FALSE);
  }

  switch (gt) {
    case gameOpen:
      gtk_toggle_button_set_active(GTK_TOGGLE_BUTTON(idc_gamesetupradio1), TRUE);
      break;
    case gameTournament:
      gtk_toggle_button_set_active(GTK_TOGGLE_BUTTON(idc_gamesetupradio2), TRUE);
      break;
    default:
      gtk_toggle_button_set_active(GTK_TOGGLE_BUTTON(idc_gamesetupradio3), TRUE);
      break;
  }

  if (hm == TRUE) {
    gtk_toggle_button_set_active(GTK_TOGGLE_BUTTON(idc_gamesetuphiddenmines), TRUE);
  } else {
    gtk_toggle_button_set_active(GTK_TOGGLE_BUTTON(idc_gamesetuphiddenmines), FALSE);
  }
  switch (ai) {
    case aiYesAdvantage:
    gtk_toggle_button_set_active(GTK_TOGGLE_BUTTON(idc_gamesetupcomptanks1), TRUE);
    gtk_toggle_button_set_active(GTK_TOGGLE_BUTTON(idc_gamesetupcomptanks2), TRUE);
    gtk_widget_set_sensitive (idc_gamesetupcomptanks2, TRUE);
    break;
  case aiYes:
    gtk_toggle_button_set_active(GTK_TOGGLE_BUTTON(idc_gamesetupcomptanks1), TRUE);
  ...
  break;
  default:
    gtk_toggle_button_set_active(GTK_TOGGLE_BUTTON(idc_gamesetupcomptanks1), FALSE);
    gtk_toggle_button_set_active(GTK_TOGGLE_BUTTON(idc_gamesetupcomptanks2), FALSE);
    gtk_widget_set_sensitive (idc_gamesetupcomptanks2, FALSE);
  ...
  if (tlimit != UNLIMITED_GAME_TIME && tlimit > 0) {
    ...
    gtk_toggle_button_set_active(GTK_TOGGLE_BUTTON(idc_gamesetuptimelimit), TRUE);
    gtk_widget_set_sensitive(idc_gamesetuptxtlimit, TRUE);
    gtk_entry_set_text(GTK_ENTRY(idc_gamesetuptxtlimit), password);
  } else {
    gtk_widget_set_sensitive (idc_gamesetuptxtlimit, FALSE);
    gtk_entry_set_text(GTK_ENTRY(idc_gamesetuptxtlimit), "");
    gtk_toggle_button_set_active(GTK_TOGGLE_BUTTON(idc_gamesetuptimelimit), FALSE);
  }
  ...
  if (sd > 0) {
    ...
    gtk_toggle_button_set_active(GTK_TOGGLE_BUTTON(idc_gamesetupstartdelay), TRUE);

  } else {
    gtk_widget_set_sensitive (idc_gamesetuptxtstartdelay, FALSE);
    gtk_entry_set_text(GTK_ENTRY(idc_gamesetuptxtstartdelay), "");
    gtk_toggle_button_set_active(GTK_TOGGLE_BUTTON(idc_gamesetupstartdelay), FALSE);
...
GtkWidget* dialogGameSetupCreate(void) {
  ...
  g_object_set_data (dialogGameSetup, "dialogGameSetup", dialogGameSetup);
  gtk_window_set_resizable (GTK_WINDOW (dialogGameSetup), FALSE);
  ...
  g_object_ref (vbox1);
  gtk_container_child_set (vbox1, dialogGameSetup, "vbox1");
  ...
  gtk_container_child_set (label1, dialogGameSetup, "label1");
  ...
  gtk_container_child_set (hbox1, dialogGameSetup, "hbox1");
  gtk_widget_show (hbox1);
  gtk_box_pack_start (GTK_BOX (vbox1), hbox1, TRUE, TRUE, 9);

  idc_gamesetupchoosemap = gtk_button_new_with_label ("Choose map");
  g_object_ref (idc_gamesetupchoosemap);

  gtk_container_child_set (idc_gamesetupchoosemap, dialogGameSetup, "idc_gamesetupchoosemap");
  ...
  g_object_ref (idc_gamesetupselectedmap);

  gtk_container_child_set (idc_gamesetupselectedmap, dialogGameSetup, "idc_gamesetupselectedmap");
  ...
  vbox1_group = gtk_radio_button_get_group (GTK_RADIO_BUTTON (idc_gamesetupradio1));
  g_object_ref (idc_gamesetupradio1);

  gtk_container_child_set (idc_gamesetupradio1, dialogGameSetup, "idc_gamesetupradio1");
  ...
  vbox1_group = gtk_radio_button_get_group (GTK_RADIO_BUTTON (idc_gamesetupradio2));
  g_object_ref (idc_gamesetupradio2);
  gtk_container_child_set (idc_gamesetupradio2, dialogGameSetup, "idc_gamesetupradio2");
  ...
  vbox1_group = gtk_radio_button_get_group (GTK_RADIO_BUTTON (idc_gamesetupradio3));
  g_object_ref (idc_gamesetupradio3);
  gtk_container_child_set (idc_gamesetupradio3, dialogGameSetup, "idc_gamesetupradio3");
  ...
  g_object_ref (idc_gamesetuphiddenmines);
  gtk_container_child_set (idc_gamesetuphiddenmines, dialogGameSetup, "idc_gamesetuphiddenmines");
  gtk_widget_show (idc_gamesetuphiddenmines);
  gtk_box_pack_start (GTK_BOX (vbox1), idc_gamesetuphiddenmines, FALSE, FALSE, 3);

  hbox2 = gtk_hbox_new (FALSE, 0);
  g_object_ref (hbox2);
  gtk_container_child_set (hbox2, dialogGameSetup, "hbox2");
  gtk_widget_show (hbox2);
  gtk_box_pack_start (GTK_BOX (vbox1), hbox2, FALSE, FALSE, 0);

  idc_gamesetupcomptanks1 = gtk_check_button_new_with_label ("Allow Computer Tanks");
  g_object_ref (idc_gamesetupcomptanks1);
  gtk_container_child_set (idc_gamesetupcomptanks1, dialogGameSetup, "idc_gamesetupcomptanks1");
  ...
  g_object_ref (idc_gamesetupcomptanks2);
  gtk_container_child_set (idc_gamesetupcomptanks2, dialogGameSetup, "idc_gamesetupcomptanks2");
  gtk_widget_set_sensitive (idc_gamesetupcomptanks2, FALSE);
  ...
  g_object_ref (hbox3);
  gtk_container_child_set (hbox3, dialogGameSetup, "hbox3");
  ...
  g_object_ref (idc_gamesetupgamepassword);
  gtk_container_child_set (idc_gamesetupgamepassword, dialogGameSetup, "idc_gamesetupgamepassword");
  ...
  g_object_ref (idc_gamesetuptextpassword);

  gtk_container_child_set (idc_gamesetuptextpassword, dialogGameSetup, "idc_gamesetuptextpassword");
  ...
  g_object_ref (hbox4);
  gtk_container_child_set (hbox4, dialogGameSetup, "hbox4");
  ...
  g_object_ref (idc_gamesetupstartdelay);
  gtk_container_child_set (idc_gamesetupstartdelay, dialogGameSetup, "idc_gamesetupstartdelay");
  ...
  g_object_ref (idc_gamesetuptxtstartdelay);
  gtk_container_child_set (idc_gamesetuptxtstartdelay, dialogGameSetup, "idc_gamesetuptxtstartdelay");
  ...
  g_object_ref (label3);
  gtk_container_child_set (label3, dialogGameSetup, "label3");
  ...
  gtk_container_child_set (hbox5, dialogGameSetup, "hbox5");
  ...
  g_object_ref (idc_gamesetuptimelimit);
  gtk_container_child_set (idc_gamesetuptimelimit, dialogGameSetup, "idc_gamesetuptimelimit");
  ...
  g_object_ref (idc_gamesetuptxtlimit);
  gtk_container_child_set (idc_gamesetuptxtlimit, dialogGameSetup, "idc_gamesetuptxtlimit");
  ...
  g_object_ref (label4);
  gtk_container_child_set (label4, dialogGameSetup, "label4");
  ...
  g_object_ref (hbox6);
  gtk_container_child_set (hbox6, dialogGameSetup, "hbox6");
  gtk_widget_show (hbox6);
  gtk_box_pack_start (GTK_BOX (vbox1), hbox6, TRUE, TRUE, 10);

  idc_gamesetupok = gtk_button_new_with_label ("OK");
  g_object_ref (idc_gamesetupok);
  gtk_container_child_set (idc_gamesetupok, dialogGameSetup, "idc_gamesetupok");
  ...
  g_object_ref (idc_gamesetupcancel);
  gtk_container_child_set (idc_gamesetupcancel, dialogGameSetup, "idc_gamesetupcancel");
  gtk_widget_show (idc_gamesetupcancel);
  gtk_box_pack_start (GTK_BOX (hbox6), idc_gamesetupcancel, TRUE, TRUE, 20);

  g_signal_connect(idc_gamesetupcancel, "clicked", G_CALLBACK(dialogGameSetupCancel), 0);
  g_signal_connect(idc_gamesetupok, "clicked", G_CALLBACK(dialogGameSetupOK), 0);
  g_signal_connect(dialogGameSetup, "delete_event", G_CALLBACK(dialogGameSetupCancel), 0);
  g_signal_connect(dialogGameSetup, "show", G_CALLBACK(dialogGameSetupShow), 0);
  g_signal_connect(idc_gamesetupgamepassword, "clicked", G_CALLBACK(dialogGameSetupPassword), 0);
  g_signal_connect(idc_gamesetuptimelimit, "clicked", G_CALLBACK(dialogGameSetupTimeLimit), 0);
  g_signal_connect(idc_gamesetupstartdelay, "clicked", G_CALLBACK(dialogGameSetupStartDelay), 0);
  g_signal_connect(idc_gamesetupcomptanks1, "clicked", G_CALLBACK(dialogGameSetupCompTanks), 0);
  g_signal_connect(idc_gamesetupchoosemap, "clicked", G_CALLBACK(dialogGameSetupChooseMap), 0);
