...
gboolean dialogGameSetupChooseMap(GtkWidget *widget,  GdkEventButton *event, gpointer user_data) {
  ...
  /*
  gtk_signal_connect(filew, "destroy", (GtkSignalFunc) DestroyDialog, &filew);
...
GtkWidget* dialogGameSetupCreate(void) {
  ...
  gtk_object_set_data (dialogGameSetup, "dialogGameSetup", dialogGameSetup);
  ...
  gtk_signal_connect(idc_gamesetupcancel, "clicked", G_CALLBACK(dialogGameSetupCancel), 0);
  gtk_signal_connect(idc_gamesetupok, "clicked", G_CALLBACK(dialogGameSetupOK), 0);
  gtk_signal_connect(dialogGameSetup, "delete_event", G_CALLBACK(dialogGameSetupCancel), 0);
  gtk_signal_connect(dialogGameSetup, "show", G_CALLBACK(dialogGameSetupShow), 0);
  gtk_signal_connect(idc_gamesetupgamepassword, "clicked", G_CALLBACK(dialogGameSetupPassword), 0);
  gtk_signal_connect(idc_gamesetuptimelimit, "clicked", G_CALLBACK(dialogGameSetupTimeLimit), 0);
  gtk_signal_connect(idc_gamesetupstartdelay, "clicked", G_CALLBACK(dialogGameSetupStartDelay), 0);
  gtk_signal_connect(idc_gamesetupcomptanks1, "clicked", G_CALLBACK(dialogGameSetupCompTanks), 0);
  gtk_signal_connect(idc_gamesetupchoosemap, "clicked", G_CALLBACK(dialogGameSetupChooseMap), 0);
