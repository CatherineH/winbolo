...
dialogNetworkInformationCreate(void)
{
  ...
  gtk_object_set_data (dialogNetworkInformation, "dialogNetworkInformation", dialogNetworkInformation);
  ...
  gtk_signal_connect(dialogNetworkInformation, "delete_event", G_CALLBACK(dialogNetworkInfoClose), NULL);
