...
GtkWidget* dialogKeySetupCreate(keyItems *value) {
  ...
  g_object_set_data (dialogKeySetup, "dialogKeySetup", dialogKeySetup);
...
gtk_entry_set_text(GTK_ENTRY(idc_keydown),gdk_keyval_name(gdk_keyval_to_upper(keySetupKeys.kiScrollDown)));
  ...
  g_signal_connect (idc_keyforward, "key_press_event",
                      G_CALLBACK(on_press),
                      &(keySetupKeys.kiForward));
  g_signal_connect (idc_keybackward, "key_press_event",
                      G_CALLBACK(on_press),
                      &(keySetupKeys.kiBackward));
  g_signal_connect (idc_keyturnleft, "key_press_event",
                      G_CALLBACK(on_press),
                      &(keySetupKeys.kiLeft));
  g_signal_connect (idc_keyturnright, "key_press_event",
                      G_CALLBACK(on_press),
                      &(keySetupKeys.kiRight));
  g_signal_connect (idc_keyincrease, "key_press_event",
                      G_CALLBACK(on_press),
                      &(keySetupKeys.kiGunIncrease));
  g_signal_connect (idc_keydecrease, "key_press_event",
                      G_CALLBACK(on_press),
                      &(keySetupKeys.kiGunDecrease));
  g_signal_connect (idc_keyshoot, "key_press_event",
                      G_CALLBACK(on_press),
                      &(keySetupKeys.kiShoot));
  g_signal_connect (idc_keymine, "key_press_event",
                      G_CALLBACK(on_press),
                      &(keySetupKeys.kiLayMine));
  g_signal_connect (idc_keypillview, "key_press_event",
                      G_CALLBACK(on_press),
                      &(keySetupKeys.kiPillView));
  g_signal_connect (idc_keytankview, "key_press_event",
                      G_CALLBACK(on_press),
                      &(keySetupKeys.kiTankView));
  g_signal_connect (idc_keyup, "key_press_event",
                      G_CALLBACK(on_press),
                      &(keySetupKeys.kiScrollUp));
  g_signal_connect (idc_keydown, "key_press_event",
                      G_CALLBACK(on_press),
                      &(keySetupKeys.kiScrollDown));
  g_signal_connect (idc_keyleft, "key_press_event",
                      G_CALLBACK(on_press),
                      &(keySetupKeys.kiScrollLeft));
  g_signal_connect (idc_keyright, "key_press_event",
                      G_CALLBACK(on_press),
