...
GtkWidget* dialogTrackerCreate(void) {
  ...
  gtk_object_set_data (dialogTracker, "dialogTracker", dialogTracker);
  ...
  gtk_signal_connect(dialogTracker, "delete_event", G_CALLBACK(dialogTrackerCancel), NULL);
  gtk_signal_connect(dialogTrackerok, "clicked", G_CALLBACK(dialogTrackerOK), 0);
  gtk_signal_connect(dialogTrackercancel, "clicked", G_CALLBACK(dialogTrackerCancel), 0);
  gtk_signal_connect(dialogTrackerUse, "clicked", G_CALLBACK(dialogTrackerUseFunc), 0);
