...
GtkWidget *background_sound1;
  ...
  gtk_container_child_set (vbox1, GTK_OBJECT (window), "vbox1");
  gtk_widget_show (vbox1);
  gtk_container_add (GTK_CONTAINER (window), vbox1);

  menu_bar = gtk_menu_bar_new ();
  gtk_widget_ref (menu_bar);
  gtk_container_child_set (menu_bar, GTK_OBJECT (window), "menu_bar");
  ...
  gtk_container_child_set (file1, GTK_OBJECT (window), "file1");
  gtk_widget_show (file1);
  gtk_container_add (GTK_CONTAINER (menu_bar), file1);

  file1_menu = gtk_menu_new ();
  gtk_widget_ref (file1_menu);
  gtk_container_child_set (file1_menu, GTK_OBJECT (window), "file1_menu");
  gtk_menu_item_set_submenu (GTK_MENU_ITEM (file1), file1_menu);
  file1_menu_accels = gtk_menu_ensure_uline_accel_group (GTK_MENU (file1_menu));

  new1 = gtk_menu_item_new_with_label ("New");
  gtk_widget_ref (new1);
  gtk_container_child_set (new1, GTK_OBJECT (window), "new1");
  ...
  gtk_container_child_set (save_map1, GTK_OBJECT (window), "save_map1");
  ...
  gtk_container_child_set (separator1, GTK_OBJECT (window), "separator1");
  ...
  gtk_container_child_set (game_information1, GTK_OBJECT (window), "game_information1");
  ...
  gtk_container_child_set (system_information1, GTK_OBJECT (window), "system_information1");
  ...
  gtk_container_child_set (network_information1, GTK_OBJECT (window), "network_information1");
  gtk_widget_show (network_information1);
  gtk_container_add (GTK_CONTAINER (file1_menu), network_information1);

  separator2 = gtk_menu_item_new ();
  gtk_widget_ref (separator2);
  gtk_container_child_set (separator2, GTK_OBJECT (window), "separator2");
  ...
  gtk_container_child_set (exit1, GTK_OBJECT (window), "exit1");
  ...
  gtk_container_child_set (edit1, GTK_OBJECT (window), "edit1");
  gtk_widget_show (edit1);
  gtk_container_add (GTK_CONTAINER (menu_bar), edit1);

  edit1_menu = gtk_menu_new ();
  gtk_widget_ref (edit1_menu);
  gtk_container_child_set (edit1_menu, GTK_OBJECT (window), "edit1_menu");
  ...
  gtk_container_child_set (frame_rate1, GTK_OBJECT (window), "frame_rate1");
  ...
  gtk_container_child_set (frame_rate1_menu, GTK_OBJECT (window), "frame_rate1_menu");
  ...
  gtk_widget_ref (_4);
  gtk_container_child_set (_4, GTK_OBJECT (window), "_4");
  gtk_widget_show (_4);
  ...
  gtk_widget_ref (_8);
  gtk_container_child_set (_8, GTK_OBJECT (window), "_8");
  gtk_widget_show (_8);
  ...
  gtk_widget_ref (_10);
  gtk_container_child_set (_10, GTK_OBJECT (window), "_10");
  gtk_widget_show (_10);
  ...
  gtk_widget_ref (_11);
  gtk_container_child_set (_11, GTK_OBJECT (window), "_11");
  gtk_widget_show (_11);
  ...
  gtk_widget_ref (_12);
  gtk_container_child_set (_12, GTK_OBJECT (window), "_12");
  gtk_widget_show (_12);
  ...
  gtk_widget_ref (_13);
  gtk_container_child_set (_13, GTK_OBJECT (window), "_13");
  gtk_widget_show (_13);
  ...
  gtk_widget_ref (_14);
  gtk_container_child_set (_14, GTK_OBJECT (window), "_14");
  gtk_widget_show (_14);
  ...
  gtk_container_child_set (window_size1, GTK_OBJECT (window), "window_size1");
  ...
  gtk_container_child_set (window_size1_menu, GTK_OBJECT (window), "window_size1_menu");
  ...
  gtk_container_child_set (normal1, GTK_OBJECT (window), "normal1");
  ...
  gtk_container_child_set (double1, GTK_OBJECT (window), "double1");
  ...
  gtk_container_child_set (quad1, GTK_OBJECT (window), "quad1");
  ...
  gtk_container_child_set (automatic_scrolling1, GTK_OBJECT (window), "automatic_scrolling1");
  ...
  gtk_container_child_set (show_gunsight1, GTK_OBJECT (window), "show_gunsight1");
  ...
  gtk_container_child_set (message_sender_names1, GTK_OBJECT (window), "message_sender_names1");
  ...
  gtk_container_child_set (message_sender_names1_menu, GTK_OBJECT (window), "message_sender_names1_menu");
  ...
  gtk_container_child_set (short1, GTK_OBJECT (window), "short1");
  ...
  gtk_container_child_set (long1, GTK_OBJECT (window), "long1");
  ...
  gtk_container_child_set (tank_labels1, GTK_OBJECT (window), "tank_labels1");
  ...
  gtk_container_child_set (tank_labels1_menu, GTK_OBJECT (window), "tank_labels1_menu");
  ...
  gtk_container_child_set (none1, GTK_OBJECT (window), "none1");
  ...
  gtk_container_child_set (short2, GTK_OBJECT (window), "short2");
  ...
  gtk_container_child_set (long2, GTK_OBJECT (window), "long2");
  ...
  gtk_container_child_set (don_t_label_own_tank1, GTK_OBJECT (window), "don_t_label_own_tank1");
  ...
  gtk_container_child_set (pillbox_labels1, GTK_OBJECT (window), "pillbox_labels1");
  ...
  gtk_container_child_set (refuelling_base_labels1, GTK_OBJECT (window), "refuelling_base_labels1");
  ...
  gtk_container_child_set (separator3, GTK_OBJECT (window), "separator3");
  ...
  gtk_container_child_set (hide_main_view1, GTK_OBJECT (window), "hide_main_view1");
  ...
  gtk_container_child_set (linbolo1, GTK_OBJECT (window), "linbolo1");
  ...
  gtk_container_child_set (linbolo1_menu, GTK_OBJECT (window), "linbolo1_menu");
  ...
  gtk_container_child_set (allow_new_players1, GTK_OBJECT (window), "allow_new_players1");
  ...
  gtk_container_child_set (allow_alliance_request1, GTK_OBJECT (window), "allow_alliance_request1");
  ...
  gtk_container_child_set (set_keys1, GTK_OBJECT (window), "set_keys1");
  ...
  gtk_container_child_set (change_player_name1, GTK_OBJECT (window), "change_player_name1");
  ...
  gtk_container_child_set (separator4, GTK_OBJECT (window), "separator4");
  ...
  gtk_container_child_set (sound_effects1, GTK_OBJECT (window), "sound_effects1");
  ...
  gtk_container_child_set (background_sound1, GTK_OBJECT (window), "background_sound1");
  ...
  gtk_container_child_set (separator5, GTK_OBJECT (window), "separator5");
  ...
  gtk_container_child_set (newswire_messages1, GTK_OBJECT (window), "newswire_messages1");
  ...
  gtk_container_child_set (assistant_messages1, GTK_OBJECT (window), "assistant_messages1");
  ...
  gtk_container_child_set (ai_brain_messages1, GTK_OBJECT (window), "ai_brain_messages1");
  ...
  gtk_container_child_set (network_status_messages1, GTK_OBJECT (window), "network_status_messages1");
  ...
  gtk_container_child_set (network_debug_messages1, GTK_OBJECT (window), "network_debug_messages1");
  ...
  gtk_container_child_set (separator6, GTK_OBJECT (window), "separator6");
  ...
  gtk_container_child_set (request_alliance1, GTK_OBJECT (window), "request_alliance1");
  ...
  gtk_container_child_set (leave_alliance1, GTK_OBJECT (window), "leave_alliance1");
  ...
  gtk_container_child_set (players1, GTK_OBJECT (window), "players1");
  ...
  gtk_container_child_set (players1_menu, GTK_OBJECT (window), "players1_menu");
  ...
  gtk_container_child_set (send_message1, GTK_OBJECT (window), "send_message1");
  ...
  gtk_container_child_set (separator7, GTK_OBJECT (window), "separator7");
  ...
  gtk_container_child_set (select_all1, GTK_OBJECT (window), "select_all1");
  ...
  gtk_container_child_set (select_none1, GTK_OBJECT (window), "select_none1");
  ...
  gtk_container_child_set (select_allies1, GTK_OBJECT (window), "select_allies1");
  ...
  gtk_container_child_set (select_nearby_tanks1, GTK_OBJECT (window), "select_nearby_tanks1");
  ...
  gtk_container_child_set (separator8, GTK_OBJECT (window), "separator8");
  ...
  gtk_container_child_set (idc_player1, GTK_OBJECT (window), "idc_player1");
  ...
  gtk_container_child_set (idc_player2, GTK_OBJECT (window), "idc_player2");
  ...
  gtk_container_child_set (idc_player3, GTK_OBJECT (window), "idc_player3");
  ...
  gtk_container_child_set (idc_player4, GTK_OBJECT (window), "idc_player4");
  ...
  gtk_container_child_set (idc_player5, GTK_OBJECT (window), "idc_player5");
  ...
  gtk_container_child_set (idc_player6, GTK_OBJECT (window), "idc_player6");
  ...
  gtk_container_child_set (idc_player7, GTK_OBJECT (window), "idc_player7");
  ...
  gtk_container_child_set (idc_player8, GTK_OBJECT (window), "idc_player8");
  ...
  gtk_container_child_set (idc_player9, GTK_OBJECT (window), "idc_player9");
  ...
  gtk_container_child_set (idc_player10, GTK_OBJECT (window), "idc_player10");
  ...
  gtk_container_child_set (idc_player11, GTK_OBJECT (window), "idc_player11");
  ...
  gtk_container_child_set (idc_player12, GTK_OBJECT (window), "idc_player12");
  ...
  gtk_container_child_set (idc_player13, GTK_OBJECT (window), "idc_player13");
  ...
  gtk_container_child_set (idc_player14, GTK_OBJECT (window), "idc_player14");
  ...
  gtk_container_child_set (idc_player15, GTK_OBJECT (window), "idc_player15");
  ...
  gtk_container_child_set (idc_player16, GTK_OBJECT (window), "idc_player16");
  ...
  gtk_container_child_set (brains1, GTK_OBJECT (window), "brains1");
  ...
  gtk_container_child_set (brains1_menu, GTK_OBJECT (window), "brains1_menu");
  ...
  gtk_container_child_set (manual1, GTK_OBJECT (window), "manual1");
  ...
  gtk_container_child_set (separator9, GTK_OBJECT (window), "separator9");
  ...
  gtk_container_child_set (help1, GTK_OBJECT (window), "help1");
  gtk_widget_show (help1);
  gtk_container_add (GTK_CONTAINER (menu_bar), help1);

  help1_menu = gtk_menu_new ();
  gtk_widget_ref (help1_menu);
  gtk_container_child_set (help1_menu, GTK_OBJECT (window), "help1_menu");
  ...
  gtk_container_child_set (help2, GTK_OBJECT (window), "help2");
  ...
  gtk_container_child_set (about1, GTK_OBJECT (window), "about1");
  ...
  gtk_container_child_set (drawingarea1, GTK_OBJECT (window), "drawingarea1");
