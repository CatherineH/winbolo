...
GtkWidget* create_MessageBox (char *name, char *label) {
  ...
  g_signal_connect(idc_messageboxok, "clicked", G_CALLBACK(messageBoxOK), 0);
  g_signal_connect(MessageBox, "delete_event", G_CALLBACK(messageBoxClose), 0);
  mbUs = MessageBox;
  return MessageBox;
}
